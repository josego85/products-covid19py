...
<head>
	...
	{{-- Agregar METAS DE FACEBOOK Y TWIITER --}}
	...
	{{-- <script id="loadMap" data_load_map={{ $data_load_map }} src="assets/js/onLoadScripts.js" type="text/javascript" charset="utf-8"></script> --}}
